...
require_once("include/permisos_funcionarios_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "rrhh_permisos.permisos_funcionarios" );
