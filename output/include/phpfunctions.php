...
function CustomExpression($value, $data, $field, $ptype, $table="")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="rrhh_permisos.permisos_funcionarios" && $field=="resultado_decision")
	{
		/*
...
;
		return $value;
				...
				if($table=="rrhh_permisos.permisos_funcionarios" && $field=="rrhh_resultado_decision")
	{
...
;
	...
	case "RECHAZADO":
		...
		return $value;
				...
				if($table=="vacacion" && $field=="resultado_decision")
	{
		/*
if ($data["resultado_decision"] == 'RECHAZADO' ) {  
     $color="red";  
...
;
		return $value;
				...
				if($table=="vacacion" && $field=="rrhh_resultado_decision")
	{
		switch ($data["rrhh_resultado_decision"]) {
	case "PENDIENTE":
		$value = '
...
function fileCustomExpression($file, $data, $field, $ptype, $table )
{
				...
				if($table=="comisionamiento" && $field=="archivo_adjunto")
	{
		...
		return $value;
				...
				if($table=="vacacion" && $field=="archivo_adjunto")
	{
		;
		return $value;
	}
...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="rrhh_permisos.permisos_funcionarios" && $field=="fecha_desde")
	{
		return now();
	}
				if($table=="rrhh_permisos.permisos_funcionarios" && $field=="hora_desde")
	{
		return "07:00";
	}
				if($table=="rrhh_permisos.permisos_funcionarios" && $field=="fecha_hasta")
	{
		return now();
	}
				if($table=="rrhh_permisos.permisos_funcionarios" && $field=="hora_hasta")
	{
		return "15:00";
	}
				...
				if($table=="comisionamiento" && $field=="hora_hasta")
	{
		return "15:00";
				...
				if($table=="comisionamiento" && $field=="motivo_id")
	{
		return 10;
	}
				if($table=="comisionamiento" && $field=="comision_servicios")
	{
		return 1;
	}
				if($table=="vacacion" && $field=="fecha_desde")
	{
		return now();
	}
				if($table=="vacacion" && $field=="hora_desde")
	{
		return "07:00";
	}
				if($table=="vacacion" && $field=="fecha_hasta")
	{
		return now();
	}
				if($table=="vacacion" && $field=="hora_hasta")
	{
		return "15:00";
	}
				if($table=="vacacion" && $field=="motivo_id")
	{
		return 1;
	}
	return "";
