...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "dbtalentos_at_192_168_123_51";
		}
		return $connId;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "rrhh_permisos.permisos_funcionarios" ] = array( "url" => "permisos_funcionarios", "type" => 0 );
	$projectEntitiesReverse[ "permisos_funcionarios" ] = "rrhh_permisos.permisos_funcionarios";
	$projectEntities[ "public.dependencias" ] = array( "url" => "dependencias", "type" => 0 );
	$projectEntitiesReverse[ "dependencias" ] = "public.dependencias";
	$projectEntities[ "public.tipo_funcionario" ] = array( "url" => "tipo_funcionario", "type" => 0 );
